...
PLACE_IN_SECTION("TAG_OTA_START") const uintptr_t MagicKeywordAddress = (uintptr_t)&MagicKeywordValue;

static BleApplicationContext_t BleApplicationContext;
static uint16_t AdvIntervalMin, AdvIntervalMax;
#define CDI_BLE_PASSKEY 0U
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      if (p_disconnection_complete_event->Connection_Handle == BleApplicationContext.BleApplicationContext_legacy.connectionHandle)
      {
        ...
        CDI_STM32WB_SetConnected(0xffff, false);
        BleApplicationContext.Device_Connection_Status = APP_BLE_IDLE;
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          CDI_STM32WB_SetConnected(p_connection_complete_event->Connection_Handle, true);
          /**
           * SPECIFIC to P2P Server APP
           */
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_GAP_PASS_KEY_REQ_VSEVT_CODE:  
          ...
          if (ret != BLE_STATUS_SUCCESS)
          {
            APP_DBG_MSG("==>> aci_gap_pass_key_resp failed: 0x%x\n", ret);
          }
...
/* USER CODE END Role_Mngt */
   ...
   */
  /* 1M is the most interoperable PHY for older Android controllers. */
