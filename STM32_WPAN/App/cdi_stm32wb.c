...
typedef struct { uint16_t service, telemetry, command, response, connection; bool connected; } cdi_ble_ctx_t;
...
void SVCCTL_InitCustomSvc(void)
{
  ...
  COPY_CDI_UUID(u.Char_UUID_128,0x00); aci_gatt_add_service(UUID_TYPE_128,(Service_UUID_t*)&u,PRIMARY_SERVICE,9,&ctx.service);
